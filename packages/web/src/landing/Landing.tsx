        ...
        <Reveal>
          <section aria-label="privacy" className="mx-auto max-w-2xl px-6 pb-24 text-center">
            <p className="font-mono text-sm text-wire [text-wrap:pretty]">
              ...
              machine and shares only derived status — never prompts, never code. Every field can be
              hidden, and <span className="text-parchment">sloppers pause</span> means paused.
            </p>
          </section>
        </Reveal>
      </main>
